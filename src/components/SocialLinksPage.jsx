const links = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5.3 7.9H1.2V21h4.1V7.9ZM3.3 1.3A2.4 2.4 0 1 0 3.3 6a2.4 2.4 0 0 0 0-4.7ZM21 13.5c0-4-2.1-5.9-5-5.9a4.3 4.3 0 0 0-3.9 2.2V7.9H8V21h4.1v-6.5c0-1.7.3-3.4 2.5-3.4 2.2 0 2.2 2 2.2 3.5V21H21v-7.5Z" /></svg>
    ),
  },
  {
    name: 'Facebook',
    ...
    icon: (
      <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M24 12a12 12 0 1 0-13.9 11.9v-8.4H7.1V12h3V9.4c0-3 1.8-4.7 4.6-4.7 1.3 0 2.7.2 2.7.2v3h-1.5c-1.5 0-2 .9-2 1.9V12h3.3l-.5 3.5h-2.8v8.4A12 12 0 0 0 24 12Z" /></svg>
    ),
  },
]
      ...
      <section className="social-card" aria-labelledby="social-title">
        ...
        <div className="social-links" aria-label="Enlaces de contacto y redes sociales">
          <a href="/" onClick={(event) => { event.preventDefault(); onNavigate('/') }} className="social-link social-link--website">
            <span className="social-link-icon"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20Zm0 0c2.2 0 4-4.5 4-10S14.2 2 12 2 8 6.5 8 12s1.8 10 4 10ZM2.5 9h19M2.5 15h19" fill="none" stroke="currentColor" strokeWidth="1.8" /></svg></span>
