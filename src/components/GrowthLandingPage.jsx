...
const pages = {
  pymes: {
    ...
    proof: ['Munay Cueros Chile', 'Pyme real publicada'],
  },
  seo: {
    ...
    proof: ['7ma Control', 'SEO local trabajado en Talca'],
  },
}
...
export default function GrowthLandingPage({ kind, onNavigate }) {
  ...
  return <><Navbar onNavigate={onNavigate} /><main>
    ...
    <ClosingCta title="Conversemos sobre tu próximo paso" text="Te daré una recomendación clara según tu negocio, sin compromiso y sin soluciones innecesarias." whatsapp={whatsapp} onNavigate={onNavigate} />
