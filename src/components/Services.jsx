      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {services.map((s) => (
          ...
          >
            ...
            <h3 className="font-display text-xl font-bold tracking-[-.025em] text-slate-900">{s.title}</h3>
