...
const faqs = [
  {
    ...
    a: 'El valor depende del tipo de proyecto. Una página web profesional para psicólogos o terapeutas parte desde $250.000 CLP. Agendemos una reunión gratuita para cotizar según lo que necesitas.',
  },
  {
