      ...
      <main>
        ...
        <Section width="wide" spacing="pt-10 pb-9 md:pt-12 md:pb-11" className="page-hero bg-gradient-to-br from-white via-white to-brand-50/70">
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr_.9fr] lg:gap-12">
            ...
            <ProjectProof name="Trabalengua" label="Tienda real publicada" />
          </div>
        </Section>
        ...
        <ClosingCta
          title="¿Vendes productos y quieres ordenarlo?"
          text="Conversemos sin compromiso. Te muestro qué tipo de tienda le conviene a tu negocio y cuánto costaría, según lo que vendes."
          whatsapp={WHATSAPP}
