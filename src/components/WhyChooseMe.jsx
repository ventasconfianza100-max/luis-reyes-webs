    ...
    <section className="difference-section bg-ink text-white">
      <div className="max-w-6xl mx-auto px-6 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {points.map((p) => (
            <div key={p.title} className="difference-card rounded-3xl bg-white/5 border border-white/10 p-5 transition-all duration-300 hover:-translate-y-1 hover:border-cyan-300/25 hover:bg-white/[.075]">
