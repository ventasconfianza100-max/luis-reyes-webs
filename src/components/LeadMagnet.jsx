    ...
    <section id="checklist" className="py-6">
      <div className="rounded-3xl bg-violet-500 text-white shadow-lg p-8 md:p-10 text-center">
        ...
        <ul className="text-left max-w-md mx-auto space-y-2.5 mb-7">
          {items.map((it) => (
            <li key={it} className="flex gap-2 text-sm text-violet-50 leading-snug">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 bg-white text-violet-600 font-semibold px-7 py-3.5 rounded-xl text-sm hover:bg-violet-50 transition-all shadow-md"
        >
