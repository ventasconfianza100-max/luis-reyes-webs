...
export default function LeadMagnet() {
  return (
    <Section id="checklist" className="lead-section">
      <div className="relative overflow-hidden rounded-3xl border border-slate-800 bg-slate-950 p-7 text-white shadow-[0_24px_70px_-40px_rgba(79,70,229,.6)] md:p-12">
        ...
        <div className="relative grid items-center gap-8 md:grid-cols-[1.05fr_.95fr] md:gap-12">
          <div>
            ...
            <h2 className="mt-4 font-display text-3xl font-extrabold tracking-tight md:text-4xl">Checklist gratis para tu web</h2>
            ...
            <a
              ...
              className="mt-7 inline-flex items-center gap-2 rounded-2xl bg-white px-6 py-3.5 text-sm font-bold text-slate-950 shadow-lg shadow-black/20 transition hover:-translate-y-0.5 hover:bg-cyan-50"
            >
          ...
          <ul className="space-y-3 rounded-2xl border border-white/10 bg-white/[.04] p-5 md:p-6">
            {items.map((it, index) => (
